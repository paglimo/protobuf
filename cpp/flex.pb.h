...
// bool locked = 1;
inline void JobLockedInfo::clear_locked() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.locked_ = false;
}
inline bool JobLockedInfo::locked() const {
  // @@protoc_insertion_point(field_get:flex.JobLockedInfo.locked)
  return _internal_locked();
}
inline void JobLockedInfo::set_locked(bool value) {
  _internal_set_locked(value);
  // @@protoc_insertion_point(field_set:flex.JobLockedInfo.locked)
}
inline bool JobLockedInfo::_internal_locked() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.locked_;
}
inline void JobLockedInfo::_internal_set_locked(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
