...
type GetGlobalFlagsResponse struct {
	state                                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_RemoteAddress               string                 `protobuf:"bytes,1,opt,name=remote_address,json=remoteAddress,proto3" json:"remote_address,omitempty"`
	xxx_hidden_MgmtdAddress                string                 `protobuf:"bytes,2,opt,name=mgmtd_address,json=mgmtdAddress,proto3" json:"mgmtd_address,omitempty"`
	xxx_hidden_Mount                       string                 `protobuf:"bytes,3,opt,name=mount,proto3" json:"mount,omitempty"`
	xxx_hidden_MgmtdTlsCertFile            string                 `protobuf:"bytes,4,opt,name=mgmtd_tls_cert_file,json=mgmtdTlsCertFile,proto3" json:"mgmtd_tls_cert_file,omitempty"`
	xxx_hidden_MgmtdTlsDisableVerification bool                   `protobuf:"varint,5,opt,name=mgmtd_tls_disable_verification,json=mgmtdTlsDisableVerification,proto3" json:"mgmtd_tls_disable_verification,omitempty"`
	xxx_hidden_MgmtdTlsDisable             bool                   `protobuf:"varint,6,opt,name=mgmtd_tls_disable,json=mgmtdTlsDisable,proto3" json:"mgmtd_tls_disable,omitempty"`
	xxx_hidden_AuthFile                    string                 `protobuf:"bytes,7,opt,name=auth_file,json=authFile,proto3" json:"auth_file,omitempty"`
	xxx_hidden_AuthDisable                 bool                   `protobuf:"varint,8,opt,name=auth_disable,json=authDisable,proto3" json:"auth_disable,omitempty"`
	xxx_hidden_NumWorkers                  int32                  `protobuf:"varint,9,opt,name=num_workers,json=numWorkers,proto3" json:"num_workers,omitempty"`
	xxx_hidden_ConnTimeoutMs               int32                  `protobuf:"varint,10,opt,name=conn_timeout_ms,json=connTimeoutMs,proto3" json:"conn_timeout_ms,omitempty"`
	xxx_hidden_LogLevel                    int32                  `protobuf:"varint,11,opt,name=log_level,json=logLevel,proto3" json:"log_level,omitempty"`
	unknownFields                          protoimpl.UnknownFields
	sizeCache                              protoimpl.SizeCache
}
...
func (x *GetGlobalFlagsResponse) GetNumWorkers() int32 {
	if x != nil {
		return x.xxx_hidden_NumWorkers
	}
	return 0
}
...
func (x *GetGlobalFlagsResponse) GetConnTimeoutMs() int32 {
	if x != nil {
		return x.xxx_hidden_ConnTimeoutMs
	}
	return 0
}
...
func (b0 GetGlobalFlagsResponse_builder) Build() *GetGlobalFlagsResponse {
	...
	x.xxx_hidden_NumWorkers = b.NumWorkers
	x.xxx_hidden_ConnTimeoutMs = b.ConnTimeoutMs
