...
type JobLockedInfo struct {
	...
	RemoteSize int64 `protobuf:"varint,6,opt,name=remote_size,json=remoteSize,proto3" json:"remote_size,omitempty"`
	// Last beegfs_mtime of the remote file or object.
	RemoteMtime *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=remote_mtime,json=remoteMtime,proto3" json:"remote_mtime,omitempty"`
	// If stub_url is not empty then path is for a stub file with the provided rst url.
	StubUrlRstId  uint32 `protobuf:"varint,8,opt,name=stub_url_rst_id,json=stubUrlRstId,proto3" json:"stub_url_rst_id,omitempty"`
	StubUrlPath   string `protobuf:"bytes,9,opt,name=stub_url_path,json=stubUrlPath,proto3" json:"stub_url_path,omitempty"`
...
func (b0 JobLockedInfo_builder) Build() *JobLockedInfo {
	...
	x.Mode = b.Mode
	x.Mtime = b.Mtime
	x.RemoteSize = b.RemoteSize
	x.RemoteMtime = b.RemoteMtime
	x.StubUrlRstId = b.StubUrlRstId
	x.StubUrlPath = b.StubUrlPath
...
type JobRequestCfg struct {
	state               protoimpl.MessageState `protogen:"hybrid.v1"`
	RemoteStorageTarget uint32                 `protobuf:"varint,1,opt,name=remoteStorageTarget,proto3" json:"remoteStorageTarget,omitempty"`
	...
	StubLocal           bool                   `protobuf:"varint,5,opt,name=stub_local,json=stubLocal,proto3" json:"stub_local,omitempty"`
	...
	LockedInfo          *JobLockedInfo         `protobuf:"bytes,9,opt,name=locked_info,json=lockedInfo,proto3" json:"locked_info,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (b0 JobRequestCfg_builder) Build() *JobRequestCfg {
	...
	x.Download = b.Download
	x.StubLocal = b.StubLocal
	x.Overwrite = b.Overwrite
	x.Flatten = b.Flatten
	x.Force = b.Force
	x.LockedInfo = b.LockedInfo
	return m0
}
...
type WorkRequest struct {
	...
	StubLocal     bool `protobuf:"varint,8,opt,name=stub_local,json=stubLocal,proto3" json:"stub_local,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkRequest) GetBuilder() *BuilderJob {
	if x != nil {
		if x, ok := x.Type.(*WorkRequest_Builder); ok {
			return x.Builder
		}
	}
	return nil
...
func (x *WorkRequest) HasBuilder() bool {
	...
	_, ok := x.Type.(*WorkRequest_Builder)
	return ok
}
...
func (x *WorkRequest) ClearBuilder() {
	if _, ok := x.Type.(*WorkRequest_Builder); ok {
		x.Type = nil
	}
}
...
func (b0 WorkRequest_builder) Build() *WorkRequest {
	...
	if b.Builder != nil {
		x.Type = &WorkRequest_Builder{b.Builder}
	}
...
type BuilderJob struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	Cfg           *JobRequestCfg         `protobuf:"bytes,1,opt,name=cfg,proto3" json:"cfg,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MockJob struct {
	...
	LockedInfo      *JobLockedInfo         `protobuf:"bytes,6,opt,name=locked_info,json=lockedInfo,proto3" json:"locked_info,omitempty"`
	Cfg             *JobRequestCfg         `protobuf:"bytes,7,opt,name=cfg,proto3" json:"cfg,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type BeeRemoteNode struct {
	...
	MgmtdAddress                string                 `protobuf:"bytes,4,opt,name=mgmtd_address,json=mgmtdAddress,proto3" json:"mgmtd_address,omitempty"`
	MgmtdTlsCertFile            string                 `protobuf:"bytes,5,opt,name=mgmtd_tls_cert_file,json=mgmtdTlsCertFile,proto3" json:"mgmtd_tls_cert_file,omitempty"`
	MgmtdTlsDisableVerification bool                   `protobuf:"varint,6,opt,name=mgmtd_tls_disable_verification,json=mgmtdTlsDisableVerification,proto3" json:"mgmtd_tls_disable_verification,omitempty"`
	MgmtdTlsDisable             bool                   `protobuf:"varint,7,opt,name=mgmtd_tls_disable,json=mgmtdTlsDisable,proto3" json:"mgmtd_tls_disable,omitempty"`
	AuthFile                    string                 `protobuf:"bytes,8,opt,name=auth_file,json=authFile,proto3" json:"auth_file,omitempty"`
	AuthDisable                 bool                   `protobuf:"varint,9,opt,name=auth_disable,json=authDisable,proto3" json:"auth_disable,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
