...
type SyncJob struct {
	...
	xxx_hidden_StubOnly   bool                   `protobuf:"varint,4,opt,name=stub_only,json=stubOnly,proto3" json:"stub_only,omitempty"`
...
func (b0 SyncJob_builder) Build() *SyncJob {
	...
	x.xxx_hidden_StubOnly = b.StubOnly
